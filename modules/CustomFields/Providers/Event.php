...
class Event extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        'cloner::cloned: App\Models\Sale\Invoice' => [
            \Modules\CustomFields\Listeners\CloneField::class,
        ],
        'cloner::cloned: App\Models\Sale\InvoiceItem' => [
            \Modules\CustomFields\Listeners\CloneField::class,
        ],
        'cloner::cloned: App\Models\Purchase\Bill' => [
            \Modules\CustomFields\Listeners\CloneField::class,
        ],
        'cloner::cloned: App\Models\Purchase\BillItem' => [
            \Modules\CustomFields\Listeners\CloneField::class,
        ],
