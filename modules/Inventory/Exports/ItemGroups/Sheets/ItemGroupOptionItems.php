...
class ItemGroupOptionItems extends Export
{
    ...
    public function map($model): array
    {
        ...
        $option_value_name = OptionValue::where('id', $model->option_value_id)->pluck('name')->first();

        $model->item_name =  $model->item->name;
        $model->option_name = $option_name;
        $model->option_value_name = $option_value_name;
