...
@section('title', trans('general.title.new', ['type' => trans_choice('Stock In', 1)]))
...
{{-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> --}}
    ...
    <div class="card">
        {!! Form::open([
            'route' => 'inventory.items.stock_in_store',
            'id' => 'item',
                            ...
                            <table class="table table-bordered" id="items">
                                <thead class="thead-light">
                                    <tr class="row">
                                        ...
                                        <th class="col-md-2">{{ trans('Stock In Quantity') }}</th>
                                        <th class="col-md-3">{{ trans('Sale Price') }}</th>
                                        <th class="col-md-3">{{ trans('Stock Price') }}</th>
                                        <th class="col-md-3">{{ trans('Total Earn') }}</th>
                                    </tr>
                                </thead>
    ...
    <script>
        $(document).on('keyup', "[quantity],[sale_price],[stock_price]", function(){
            $("[total]").each(function() {
                ...
                var total = (quantity*sale_price)-(quantity*stock_price);
