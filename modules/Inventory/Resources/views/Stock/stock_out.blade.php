...
@section('title', trans_choice('Stock Out', 2))

@section('new_button')
    @can('create-common-items')
        <span><a href="{{ route('inventory.items.stock_out_create') }}" class="btn btn-success btn-sm header-button-top">{{ trans('general.add_new') }}</a></span>
                ...
                <table class="table table-flush table-hover">
                    <thead class="thead-light">
                        <tr class="row table-head-line">
                            ...
                            <th class="col-xs-4 col-sm-6 col-md-5 col-lg-2 col-xl-3">@sortablelink('name', trans('general.name'), ['filter' => 'active, visible'])</th>
                            <th class="col-lg-3 col-xl-3 d-none d-lg-block">@sortablelink('quantity', trans('Stock Out'))</th>
                            {{-- <th class="col-lg-2 col-xl-2 text-left d-none d-md-block">@sortablelink('sale_price', trans('Sale Price'))</th> --}}
                            <th class="col-md-3 col-lg-3 col-xl-2 text-left d-none d-md-block">@sortablelink('sale_price', trans('Sale Price'))</th>
                    ...
                    <tbody>
                        @foreach($items as $item)
                            <tr class="row align-items-center border-top-1">
                                ...
                                <td class="col-lg-3 col-xl-3 d-none d-lg-block">
                                    {{ $item->quantity }}
                                </td>
