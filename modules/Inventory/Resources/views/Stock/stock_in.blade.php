...
@section('title', trans_choice('Stock In', 2))

@section('new_button')
    @can('create-common-items')
        <span><a href="{{ route('inventory.items.stock_in_create') }}" class="btn btn-success btn-sm header-button-top">{{ trans('general.add_new') }}</a></span>
                ...
                <table class="table table-flush table-hover">
                    <thead class="thead-light">
                        <tr class="row table-head-line">
                            ...
                            <th class="col-xs-4 col-sm-6 col-md-5 col-lg-1 col-xl-2">@sortablelink('name', trans('general.name'), ['filter' => 'active, visible'])</th>
                            <th class="col-lg-2 col-xl-2 d-none d-lg-block">@sortablelink('quantity', trans('Stock In'))</th>
                            <th class="col-lg-2 col-xl-2 text-left d-none d-md-block">@sortablelink('sale_price', trans('Sale Price'))</th>
                            <th class="col-md-3 col-lg-3 col-xl-2 text-left d-none d-md-block">@sortablelink('stock_price', trans('Stock_Price'))</th>
                            <th class="col-lg-2 col-xl-2 text-left d-none d-lg-block">@sortablelink('created_at', trans('Created at'))</th>
                    ...
                    <tbody>
                        @foreach($items as $item)
                            <tr class="row align-items-center border-top-1">
                                ...
                                {{-- </td> --}}
                                <td class="col-xs-4 col-sm-6 col-md-5 col-lg-1 col-xl-2 py-2">
                                    {{ $item->item }}-({{ $item->item }})
                                </td>
                                ...
                                <td class="col-md-3 col-lg-3 col-xl-2 text-left d-none d-md-block">
                                    {{ money($item->stock_price, setting('default.currency'), true) }}
                                </td>
