...
@section('title', trans('general.title.new', ['type' => trans_choice('inventory::general.options', 1)]))
        ...
        {!! Form::open([
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    {{ Form::selectGroupGroup('type', trans_choice('general.types', 1), 'exchange-alt', $types, null ,['change' => 'onTypeChange']) }}
            ...
            <div class="card-footer">
                <div class="row save-buttons">
                    {{ Form::saveButtons('inventory.options.index') }}
                </div>
            </div>
        {!! Form::close() !!}
    </div>
