        ...
        {!! Form::model($item_group, [
            ...
            <div class="card-body">
               <div class="row">
                    ...
                    {{ Form::multiSelectAddNewGroup('tax_ids', trans_choice('general.taxes', 1), 'percentage', $taxes, $item_group->tax_ids, ['path' => route('modals.taxes.create'), 'field' => ['key' => 'id', 'value' => 'title']], 'col-md-6 el-select-tags-pl-38') }}
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="options">
                                ...
                                <tbody>
                                    ...
                                    <tr class="row mb-10" id="option-row-{{ $option_row }}">
                                        @stack('name_td_start')
                                        <td class="col-md-3">
                                            @stack('name_input_start')
                                            {!! Form::select('option_id', $options, empty($select_option) ? null : $select_option->option_id, array_merge(['id' => 'option-' . $option_row . '-name', 'class' => 'form-control select-option-name', 'placeholder' => trans('general.form.select.field', ['field' => trans_choice('inventory::general.options', 1)]), 'disabled' => 'disabled'])) !!}
                                        ...
                                        <td class="col-md-9">
                                            ...
                                            {{ Form::multiSelectGroup('option_value', '', 'exchange', !empty($select_option->option) ? $select_option->option->values()->orderBy('name')->pluck('name', 'id') : [], $select_option_values, ['disabled' => "true"], 'col-md-12') }}
