...
@section('new_button')
    @permission('create-inventory-item-groups')
        ...
        <span><a href="{{ route('import.create', ['inventory', 'item_groups']) }}" class="btn btn-white btn-sm header-button-top">{{ trans('import.import') }}</a></span>
    @endpermission
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        ...
                                        @permission('delete-inventory-item-groups')
                                            <div class="dropdown-divider"></div>
                                            {!! Form::deleteLink($item_group, 'inventory.item-groups.destroy') !!}
                                        @endpermission
                                    </div>
                                </div>
                            </td>
