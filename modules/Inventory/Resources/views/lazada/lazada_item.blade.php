...
@section('title', trans_choice('lazada Items', 2))
                ...
                <table class="table table-flush table-hover">
                    <thead class="thead-light">
                        <tr class="row table-head-line">
                            ...
                            <th class="col-xs-4 col-sm-6 col-md-5 col-lg-2 col-xl-3">@sortablelink('name', trans('Name-SKU'), ['filter' => 'active, visible'])</th>
                            <th class="col-lg-2 col-xl-2 d-none d-lg-block">@sortablelink('category', trans_choice('general.categories', 1))</th>
                            <th class="col-lg-3 col-xl-3 text-center d-none d-md-block">{{ trans('Brand') }}</th>
                            <th class="col-md-3 col-lg-3 col-xl-2 text-right d-none d-md-block">@sortablelink('sale_price', trans('settings.invoice.quantity'))</th>
                            <th class="col-lg-2 col-xl-2 text-right d-none d-lg-block">@sortablelink('purchase_price', trans('Price'))</th>
                        ...
                        @foreach($items as $item)
                            <tr class="row align-items-center border-top-1">
                                ...
                                <td class="col-xs-4 col-sm-6 col-md-5 col-lg-2 col-xl-3 py-2">
                                    ...
                                    <a href="#">{{ $item->name }}-{{ $item->SKU_ID }}</a>
                                </td>
                                <td class="col-lg-2 col-xl-2 d-none d-lg-block">
                                    {{ $item->warrenty_type }}
                                </td>
                                <td class="col-lg-3 col-xl-3 text-center d-none d-md-block">
                                    {{ $item->brand }}
                                </td>
                                ...
                                <td class="col-lg-2 col-xl-2 text-right d-none d-lg-block">
                                    {{ money($item->price, setting('default.currency'), true) }}
                                </td>
