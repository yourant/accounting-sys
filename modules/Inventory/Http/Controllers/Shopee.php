...
{   
    ...
    {   
        ...
        return view('inventory::shopee.shopee_item', compact('item_total','first','items','limit','limit_pages'));
    }

    public function shopee_orders()
    {   
        if(isset($_GET['limit'])){
            if(isset($_GET['page'])){
                $skip = $_GET['limit']*($_GET['page']-1);
        ...
        return view('inventory::shopee.shopee_orders', compact('item_total','first','items','limit','limit_pages'));
    }
