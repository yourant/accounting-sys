    ...
    <table class="table table-hover align-items-center rp-border-collapse">
        <thead class="border-top-style">
            <tr class="row rp-border-bottom-1 font-size-unset px-3">
                ...
                <th class="<?php echo e($class->column_name_width); ?> text-right pl-0 pr-4 border-top-0 rp-border-bottom-1"><?php echo e(trans_choice('general.totals', 1)); ?></th>
            </tr>
        </thead>
    </table>
</div>
<?php /**PATH C:\xampp\htdocs\akaunting-master-from-mbp\resources\views/reports/tax_summary/content/header.blade.php ENDPATH**/ ?>