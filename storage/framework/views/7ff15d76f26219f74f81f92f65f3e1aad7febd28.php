        ...
        <?php echo Form::model($item, [
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <?php echo e(Form::textGroup('sku', trans('inventory::general.sku'), 'fa fa-key', ['required' => 'required'], $sku)); ?>
                    ...
                    <?php echo e(Form::fileGroup('picture', trans_choice('general.pictures', 1), '', ['dropzone-class' => 'form-file', 'options' => ['acceptedFiles' => 'image/*']])); ?>
                        ...
                        <?php echo $__env->yieldPushContent('track_inventory_input_start'); ?>
                            <div id="item-track-inventory" class="form-group col-md-12 margin-top">
                                <div class="custom-control custom-checkbox">
                                    <?php echo e(Form::checkbox('track_inventory', '1', $track_control, [
            ...
            <?php if (app('laratrust')->isAbleTo('update-common-items')) : ?>
...
<?php $__env->startPush('scripts_start'); ?>
    <script type="text/javascript">
        var inventory_items = <?php echo json_encode($inventory_items); ?>;
    </script>

    <script src="<?php echo e(asset('modules/Inventory/Resources/assets/js/items.min.js?v=' . module_version('inventory'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\akaunting-master-from-mbp\modules\Inventory\Providers/../Resources/views/items/edit.blade.php ENDPATH**/ ?>